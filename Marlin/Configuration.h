...
#define STRING_CONFIG_H_AUTHOR "(amaider, 11_01_2021)" // Who made the changes.
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -40, -10, -1.025 }
